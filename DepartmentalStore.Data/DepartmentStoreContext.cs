...
namespace DepartmentalStore.Data
{
    public class DepartmentStoreContext : DbContext
    {
        ...
        {
            //optionsBuilder.UseNpgsql("DataSource=DESKTOP-ANR4288;Initial Catalog=DepartmentalDB;Integrated Security=True");
            optionsBuilder.UseNpgsql("Server = localhost; Port = 5432; DataBase = DepartmentalDB ; Username = postgres; Password = yanshik");
