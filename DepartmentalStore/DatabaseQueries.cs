...
namespace DepartmentalStore
{
    public class DatabaseQueries
    {
        ...
        {
            var staffdata = context.staff.Where(x => x.FirstName == "Yanshik").ToList();
        ...
        {
            var staffdata = context.staff.Where(x => x.Email == "har123@gmail.com").ToList();
            foreach (var sd in staffdata)
            {
                Console.WriteLine(sd.staffId + " " + sd.RoleId + " " + sd.AddressId + " " + sd.FirstName + " " + sd.LastName + " " + sd.Email);
            }
        ...
        public static void ListOfSuppliers()
        {
            ...
            var suppliers2 = context.Supplier.Where(x => x.Email == "rex123@gmail.com");
